...
echo ""
echo "Installing build helpers (needed for flash-attn source build)..."
pip install -U ninja cmake packaging
...
# -----------------------------
# flash-attn: force source build (recommended on nightly)
# -----------------------------
echo ""
echo "Installing flash-attn from source (nightly-friendly)..."
